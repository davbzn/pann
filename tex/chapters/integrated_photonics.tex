...
To summarize, the empirical values of the nonlinear constants introduced in \Cref{ssec:Electronic_nonlinearities,ssec:Charge_carrier_nonlinearities,ssec:Thermal_nonlinearities} are collected in \autoref{tab:nonlinearities}.
...
The idea of this work is to tackle the problem head on and develop a framework for \ac{FFNN} based on optical effects.
