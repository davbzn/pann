...
\tikzsetnextfilename{relu_evolution}
...
%			cycle list name=color list,
		...
		\addlegendimage{semithick, orange!80!magenta, mark=o, mark options={scale=1}}
		...
		\addplot [cyan, train] table [x index=0, y index=6] {tikz/base-11x3_learn.csv};
		\addplot [cyan, valid] table [x index=0, y index=6] {tikz/base-11x3_valid.csv};
		
		\addlegendentry{$2\times 22$}
		\addplot [lime!50!teal, train] table [x index=0, y index=9] {tikz/base-22x2_learn.csv};
		\addplot [lime!50!teal, valid] table [x index=0, y index=9] {tikz/base-22x2_valid.csv};
		
		\addlegendentry{$3\times 22$}
		\addplot [orange!80!magenta, train] table [x index=0, y index=7] {tikz/base-22x3_learn.csv};
		\addplot [orange!80!magenta, valid] table [x index=0, y index=7] {tikz/base-22x3_valid.csv};
