...
\tikzsetnextfilename{Train_evolution_OB}
...
%			xmin=-199, xmax=2199,
		...
		\addplot [orange, train] {0.2+2.5*exp(-0.01*x)+0.05*rand};
		\addlegendentry{$3\times 11$}
		\addplot [orange, valid] {0.4+2.3*exp(-0.01*x)+0.1*rand};
		
		\addplot [violet, train] {0.15+2.6*exp(-0.011*x)+0.06*rand};
		\addlegendentry{$3\times 22$}
		\addplot [violet, valid] {0.35+2.35*exp(-0.012*x)+0.13*rand};
