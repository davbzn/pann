...
%	  \pgfplotstableread[col sep=tab]{tikz/M1.csv}\tableM1
		...
		\draw [help lines, <-] ({1551.9+0.3+0.1}, 0.306) -- ({1551.9+0.3+0.1+0.8}, 0.306)
				node [right, align=left] {\small $FWHM$\\\SI{0.6+-0.05}{\nm}};
		\draw [help lines, <-] ({1551.9-0.4-0.1}, 0.306) -- ({1551.9-0.4-0.1-0.8}, 0.306);
		
		\draw [help lines] (1551.9, -0.1) -- (1551.9, 0.8) node [pos=.85, right] {$\lambda_{res}=\SI{1551.9+-0.1}{\nm}$};
